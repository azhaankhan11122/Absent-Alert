...
export const api = {
  ...
  approveSms: (id) => request(`/sms-queue/${id}/approve`, { method: 'POST' }),
  approveAllSms: () => request('/sms-queue/approve-all', { method: 'POST' }),
  deleteSms: (id) => request(`/sms-queue/${id}`, { method: 'DELETE' }),
